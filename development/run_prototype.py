#!/usr/bin/env python3
"""
Legacy Prototype Launcher for Tick-Tock Widget
This script ensures the application runs in legacy prototype mode
"""
...
def main():
    ...
    print()
    print("=" * 50)
    print("   TICK-TOCK WIDGET - LEGACY PROTOTYPE MODE")
    print("=" * 50)
    print()
    
    # Set environment to prototype
    os.environ["TICK_TOCK_ENVIRONMENT"] = "prototype"
    ...
    print("Starting Tick-Tock Widget in LEGACY PROTOTYPE mode...")
    print("Data will be saved to: tick_tock_projects_prototype.json")
    print()
